...
% dynGenie3 (Figures 5 and 6, cases d) e) and f)).
...
% emtab_1908_L_15_res.mat, emtab_1908_L_10_res.mat or 
% emtab_1908_L_8_res.mat 
...
if not(do_sim)
    ...
    filename= ['Bio_Example_data_results/results/',file_name_2,'_res.mat'];
    load  (filename)
    ...
    for num_net=2
        ...
        for num_test=1:n_tests
         ...
         eval (['save Bio_Example_data_results/results/',file_name_2,'_redo_res.mat'])
