...
% of Dream4 challenge, using the first half of data, 
% when the perturbation is applied - 10 time-series, each one
% of 11 time points; we replicate the data-set 20 times by adding noise and 
% sampling the data-set for generating time series of 21 time points.
% In the code, there is a flag (do_sim), which is true if you choose to do 
% the simulation, otherwise you can load the file 
% res_perf_Bempty_tps21_from_0to500_rep20.mat 
% (within the folder Data_results_figs_3_4_S1/results/), where the 
% identified variables have been saved.
% The script generates the plots reported in the second column of Fig S1.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   load Data_results_figs_3_4_S1/results/res_perf_Bempty_tps21_from_0to500_rep20.mat
    ...
    for num_net=1:n_networks 
        ...
        for num_test=2:n_tests
            ...
            v_tps=[1:21,42:62,83:103,124:144,165:185,206:226, 247:267, 288:308, 329:349, 370:390];
...
%               v_tps=[21:2:41,62:2:82,103:2:123,144:2:164,185:2:205,226:2:246, 267:2:287, 308:2:328, 349:2:369, 390:2:410];
        ...
        save ('Data_results_figs_3_4_S1/results/res_perf_Bempty_tps21_from_0to500_rep20_redo.mat')
...
for num_id_net=1:n_networks
    ...
    ylabel('AUPR')
    xlabel('AUROC')
    str_title=[name_net,', tps=',num2str(num_pts),' in [0 500] min'];
    title(str_title)   
