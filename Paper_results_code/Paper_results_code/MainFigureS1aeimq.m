...
% res_perf_Bempty_tps11_from_0to500_rep20.mat 
% (within the folder Data_results_figs_3_4_S1/results/), where the 
% identified variables have been saved.
% The script generates the plots reported in the first column of Fig S1.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if not(do_sim)
   ...
   load Data_results_figs_3_4_S1/results/res_perf_Bempty_tps11_from_0to500_rep20.mat
    ...
    for num_net=1:n_networks 
        ...
        save ('Data_results_figs_3_4_S1/results/res_perf_Bempty_tps11_from_0to500_rep20_redo.mat')
