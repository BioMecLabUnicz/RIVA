...
% when the perturbation is removed - 10 time-series, each one of 
% 11 time points; we replicate the data-set 20 times by adding noise and 
...
% res_perf_B0_tps21_from_500to1000_rep20.mat 
% (within the folder Data_results_figs_3_4_S1/results/), where the 
% identified variables have been saved.
% The script generates the plots reported in the fourth column of Fig S1.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   load Data_results_figs_3_4_S1/results/res_perf_B0_tps21_from_500to1000_rep20.mat
    ...
    for num_net=1:n_networks 
        ...
        for num_test=2:n_tests            
            ...
            v_tps=[21:41,62:82,103:123,144:164,185:205,226:246, 267:287, 308:328, 349:369, 390:410];
        ...
        save ('Data_results_figs_3_4_S1/results/res_perf_B0_tps21_from_500to1000_rep20_redo.mat')
