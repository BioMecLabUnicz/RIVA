...
function Meas_mtx_flt_all=ljung_mthd_ls(Meas_sim,Err_mtx,num_tps_4exp,ord_ar_no_model)
...
Z_err_pinv=pinv(Z_err);

par_ar_no_model= Z_err_pinv*X_err;
