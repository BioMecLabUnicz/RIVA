...
function perf_ind_dir = ppv_sens_spec_dir(Orig_mtx,Rec_mtx)
...
%
% OUTPUT VARIABLES
% performance evaluation taking into account the direction of the arcs of 
% network / matrix connectivity (DIRECTED NETWORK)                              
%                                     
% Perf_idx: it is a row vector 
%                      first column -->  ppv value                                     
%                      second column --> sensitivity value 
%                      third column --> specificity value 
%                      fourth column--> false positive value
%                      
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% row vector containing ppv, sensitivity and specificity values
perf_ind_dir=[PPV_dir,sensitivity_dir,specificity_dir,false_positive_dir];
